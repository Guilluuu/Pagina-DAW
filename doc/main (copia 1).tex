...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/clinicas-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/clinicas-mobile.png}
\caption{Clínicas: versión escritorio (izquierda) y móvil (derecha)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/sobre-nosotros-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/sobre-nosotros-mobile.png}
\caption{Sobre nosotros: versión escritorio (izquierda) y móvil (derecha)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/pedir-cita-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/pedir-cita-mobile.png}
\caption{Solicitud de cita: versión escritorio (izquierda) y móvil (derecha)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/servicios-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/servicios-mobile.png}
\caption{Servicios: versión escritorio (izquierda) y móvil (derecha)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/consejos-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/consejos-mobile.png}
\caption{Consejos de salud: versión escritorio (izquierda) y móvil (derecha)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/sobre-nosotros-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/sobre-nosotros-mobile.png}
\caption{Sobre nosotros: aspecto en escritorio y en móvil con la pestaña activa resaltada}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/clinicas-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/clinicas-mobile.png}
\caption{Clínicas: buscador y controles de filtrado en escritorio y en móvil}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/index-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/index-mobile.png}
\caption{Página principal: sección de consejos destacados rotatorios en escritorio y móvil}
\end{figure}
...
\begin{lstlisting}[language=JavaScript, caption=Lógica JS para la generación aleatoria y transiciones animadas]
// 1. Temporizador ciclico (setInterval)
document.addEventListener("DOMContentLoaded", () => {
...
function renderizarConsejos(listaConsejos) {
    ...
    setTimeout(() => {
        ...
        listaConsejos.forEach((consejo, indice) => {
            let dir = indice === 0
                ? "consejo-home--imagen-izquierda"
                : "consejo-home--imagen-derecha";
            contenedor.innerHTML += `
                <a href="consejo-especifico.html?id=${consejo.id}"
                   class="consejo-home-enlace">
                  <article class="consejo-home ${dir}">
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/pedir-cita-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/pedir-cita-mobile.png}
\caption{Formulario de cita: nombre y ubicación de la clínica autocompletados en escritorio y móvil}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/servicios-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/servicios-mobile.png}
\caption{Servicios: carga dinámica desde XML en escritorio y en móvil}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.64\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/urgencias-desktop.png}%
\hfill%
\includegraphics[width=0.30\linewidth,height=0.50\textheight,keepaspectratio]{capturas_responsivas/urgencias-mobile.png}
\caption{Urgencias: clínicas filtradas dinámicamente desde JSON en escritorio y móvil}
\end{figure}
