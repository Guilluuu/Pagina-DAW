...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{capturas_js/nav-dinamica-sobre-nosotros-1.png} % Nota: Asumo que la extensión es .png por consistencia, ajusta a .jpg si fuera necesario según tu árbol.
        \caption{Pestaña de sostenibilidad activa}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{capturas_js/nav-dinamica-sobre-nosotros-2.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{capturas_js/buqueda-dinamica-1.png}
        \caption{Vista general de clínicas (sin filtros)}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{capturas_js/buqueda-dinamica-2.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{capturas_js/consejos-dinamicos-1.png}
        \caption{Estado inicial de los consejos dinámicos}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{capturas_js/consejos-dinamicos-2.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{capturas_js/autocompletado-1.png}
        \caption{Formulario previo a la selección}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{capturas_js/autocompletado-2.png}
