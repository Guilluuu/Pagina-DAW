...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/clinicas-desktop.png}}
...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/sobre-nosotros-desktop.png}}
...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/pedir-cita-desktop.png}}
...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/servicios-desktop.png}}
...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/consejos-desktop.png}}
...
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/sobre-nosotros-desktop.png}}
\caption{Sobre nosotros: sistema de pestañas en escritorio}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/sobre-nosotros-tablet.png}
\caption{Sobre nosotros: sistema de pestañas en tablet}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.38\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/sobre-nosotros-mobile.png}
\caption{Sobre nosotros: sistema de pestañas en móvil}
\end{figure}
...
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/clinicas-desktop.png}}
\caption{Clínicas: buscador y filtros en escritorio}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/clinicas-tablet.png}
\caption{Clínicas: buscador y filtros en tablet}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.38\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/clinicas-mobile.png}
\caption{Clínicas: buscador y filtros en móvil}
\end{figure}
...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/index-desktop.png}}
\caption{Página principal: consejos destacados rotatorios en escritorio}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/index-tablet.png}
\caption{Página principal: consejos destacados rotatorios en tablet}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.38\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/index-mobile.png}
\caption{Página principal: consejos destacados rotatorios en móvil}
\end{figure}
...
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/pedir-cita-desktop.png}}
\caption{Formulario de cita: nombre y ubicación autocompletados en escritorio}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/pedir-cita-tablet.png}
\caption{Formulario de cita: autocompletado en tablet}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.38\linewidth,height=0.55\textheight,keepaspectratio]{capturas_responsivas/pedir-cita-mobile.png}
\caption{Formulario de cita: autocompletado en móvil}
\end{figure}
...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/urgencias-desktop.png}}
...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/servicio-especifico-desktop.png}}
...
\begin{figure}[H]
\centering
\rotatebox{90}{\includegraphics[width=0.85\textheight,keepaspectratio]{capturas_responsivas/consejo-especifico-desktop.png}}
